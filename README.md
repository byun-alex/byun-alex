...
- **[brain-dashboard](https://github.com/byun-alex/brain-dashboard)** — a local "Jarvis" web app: chat + a real embedded Claude terminal (WebSocket/ConPTY + xterm.js), project context switching, live token-cost tracking. Node + vanilla JS.
